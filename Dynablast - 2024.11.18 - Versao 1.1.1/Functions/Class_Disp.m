classdef Class_Disp
    ...
    % negative: negative phase (0 for not and 1 for extended positive
    % phase or 2 for cubic equation)
    ...
    methods (Static)
        ...
        function [dydt] = Equation...
                (t, y, phase_disp, negative, rho, h, sup, pmax, pmin, ...
                td, tm, expo, K1, K3)
            ...
            if and(phase_disp == 2, negative == 1)

                % Negative phase using Extended Positive Phase
                Pos = pmax * ( 1 - (t / td) ) * exp(- expo * t / td);
            ...
            if and(phase_disp == 2, negative == 2)

                % Negative phase using Cubic Equation
    ...
    methods
        ...
        function this = Displacement...
            ...
            [t,y] = ode45(@(t,y) this.Equation...
                (t, y, 1, negative, rho, h, sup, pmax, pmin, ...
                td, tm, expo, K1, K3),  ...
                [0 td], [0 0]);
            this.s1 = [t,y];
            ...
            if negative == 0
                ...
                [t,y] = ode45(@(t,y) this.Equation...
                    (t, y, 3, negative, rho, h, sup, pmax, pmin, ...
                    td, tm, expo, K1, K3), ...
            ...
            if negative == 1 || negative == 2      
                ...
                [t,y] = ode45(@(t,y) this.Equation...
                    (t, y, 2, negative, rho, h, sup, pmax, pmin, ...
                    td, tm, expo, K1, K3), ...
