classdef Class_Plot < handle
    ...
    % R: Distance (m)
    % W: TNT's mass (kg)
    % parameter_distance: input data about distance (1 for using scaled
    % distance Z or 2 for using distance R)
    ...
    methods (Static)
        ...
        % Function to draw the graphic
        function drawTNT(graphic_local, Z, R, W, parameter_distance)
        ...
        % Function to draw 
        function plotDraw...
                (graphic_local, a, beta, h, nonlinear, type_sup, Z, R, ...
                W, parameter_distance)
...
%             clf reset
            ...
            % Draw TNT
            draw.drawTNT(graphic_local, Z, R, W, parameter_distance);
